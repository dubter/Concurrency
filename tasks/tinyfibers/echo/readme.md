...
Вам потребуется интеграция планировщика файберов и цикла событий из `asio`, эта часть уже должна быть готова после решения [SleepFor](/tasks/tinyfibers/sleep). 

Если вы написали там хороший код, то в логику работы планировщика изменений вносить не потребуется.
