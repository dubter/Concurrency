...
Чем больше число ядер / потоков, исполняющих критические секции, тем выше накладные расходы на синхронизацию в самом мьютексе, и тем меньше пользы от кэшей, так как разделяемые данные, к которым обращаются критические секции, придется постоянно двигать между ядрами.

##### Strand

Гораздо разумнее двигать не данные к критическим секциям на разные ядра, а наоборот – критические секции перенести на одно ядро.
