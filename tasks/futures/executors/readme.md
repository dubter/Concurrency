...
[`Strand`](exe/executors/strand.hpp) – экзекутор, запускающий задачи (можно назвать их критическими секциями) строго _последовательно_, с учетом порядка, в котором они были запланированы.
