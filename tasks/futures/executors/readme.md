...
Релизуйте простой пул потоков фиксированного размера с общей блокирующей очередью задач.
...
Положите в директорию [`support`](mtf/support) общие компоненты, которые используются экзекуторами, но при этом имеют самостоятельную ценность:
- Спинлок
