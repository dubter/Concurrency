...
И stackful корутины, и файберы описывают вычисления, которые можно остановить, а затем – возобновить. Обе сущности построены на нелокальной передаче управления, обе используют механизм переключение контекста.
...
Файберам нужны собственные средства синхронизации: мьютексы, кондвары, каналы и т.д.
