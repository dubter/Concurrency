...
Эту стратегию будем называть _Awaiter_.
...
Заворачивание лямбды в `std::function` или подобный контейнер с type erasure – тоже потенциальная аллокация.
...
В файбере не должно быть дополнительной синхронизации: ни взаимного исключения, ни ожидания других потоков.
