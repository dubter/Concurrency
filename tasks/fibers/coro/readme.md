...
Такие корутины можно реализовать самостоятельно, в виде библиотеки, для реализации потребуется процедура переключения контекста исполнения.
...
Корутина умеет останавливать и возобновлять свое исполнение, а значит у нее должен быть собственный контекст исполнения, который представлен классом [`ExecutionContext`](https://gitlab.com/Lipovsky/sure/-/blob/master/sure/context.hpp).
