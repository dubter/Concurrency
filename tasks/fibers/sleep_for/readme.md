...
Работа с таймером должна быть заключена в функции `SleepFor`. Класс `Fiber` не должен знать про каждый IO-объект или примитив синхронизации, с которым он работает.
