...
Если на предыдущем шаге вы развернули контейнер, то **залогинтесь в него и перейдите в корень репозитория**. Если вы работаете без докера, то просто перейдите в корень репозитория.
