...
[Настройте Clion](/docs/clion.md) или [VScode](vscode.md) для комфортной работы с курсом.
...
Обратите внимание: сборка проекта курса через Clippy и сборка через CLion или VScode работают **независимо** друг от друга!
